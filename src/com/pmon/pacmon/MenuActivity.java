...
//		optionsButton.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.bSingle: //start single player game
			Intent sGame = new Intent("com.pmon.pacmon.LEVELSELECTACTIVITY");
			startActivity(sGame);
			break;
...
//			startActivity(mGame);
//			break;
			Intent cmGame = new Intent("com.pmon.pacmon.CLIENTORSERVER");
...
//			break;
		...
		case R.id.bAbout:
			Intent iAbout = new Intent("com.pmon.pacmon.ABOUTACTIVITY");
