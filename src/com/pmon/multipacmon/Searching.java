...
import com.pmon.clientmultiserver.CMGameActivity;
import com.pmon.pacmon.ClientOrServer;
import com.pmon.pacmon.R;
import com.pmon.pacmon.SoundEngine;
	                ...
	                if (progressStatus) {
	                    ...
	                    new Thread(new Runnable()
	                	{
	                		public void run()
	                		{
	                			...
	                			//start mgameactivity
	                			Intent cmGame = new Intent("com.pmon.multipacmon.MGAMEACTIVITY");
